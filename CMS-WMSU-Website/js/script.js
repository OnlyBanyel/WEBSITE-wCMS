$(document).ready(() => {
  ...
  function initFormHandlers() {
    ...
    if (typeof jQuery == "undefined") {
      console.error(
        "jQuery is not loaded. Please ensure jQuery is included in your HTML."
      );
        ...
        $.ajax({
          ...
          error: (xhr, status, error) => {
            ...
            if (
              ...
              console.error(
                "Server returned HTML instead of JSON. Possible session timeout."
              );
  ...
  $(document).on("submit", "form[id$='-items']", function (e) {
    ...
    var titleSectionID = $(this)
      .find("input.courseTitle")
      .data("titlesectionid");
    var currentPage = $(".dynamic-load.active").data("file");
  ...
  $(document).on("submit", "form[id^='overviewImg-']", function (e) {
    ...
    formData.append(
      "imageIndex",
      form.find("input[name='overviewImgIndex']").val()
    );
  ...
  $(document).on("submit", "form[id$='-overviewItems']", function (e) {
    ...
    var overviewSectionID = form
      .find("input.overviewTitle")
      .data("overviewsectionid");
