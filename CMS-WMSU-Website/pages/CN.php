...
if (empty($_SESSION['account'])){ 
    ...
    $_SESSION['cnPage']['CarouselElement'] = $cnPage->fetchSectionsByIndicator('Carousel Element', $pageID, $subpageID);
    $_SESSION['cnPage']['genInfoFront'] = $cnPage->fetchSectionsByIndicator('General-Info', $pageID, $subpageID);
    $_SESSION['cnPage']['genInfoBack'] = $cnPage->fetchSectionsByIndicator('General-Info-Back', $pageID, $subpageID);
    $_SESSION['cnPage']['department'] = $cnPage->fetchSectionsByIndicator('Departments', $pageID, $subpageID);
    $_SESSION['cnPage']['AccordionCourses'] = $cnPage->fetchSectionsByIndicator('Accordion Courses', $pageID, $subpageID);
    $_SESSION['cnPage']['AccordionCoursesUndergrad'] = $cnPage->fetchSectionsByIndicator('Accordion Courses Undergrad', $pageID, $subpageID);
    $_SESSION['cnPage']['AccordionCoursesGrad'] = $cnPage->fetchSectionsByIndicator('Accordion Courses Grad', $pageID, $subpageID);
