...
if (empty($_SESSION['account'])){ 
    ...
    $_SESSION['csmPage']['CarouselElement'] = $csmPage->fetchSectionsByIndicator('Carousel Element', $pageID, $subpageID);
    $_SESSION['csmPage']['genInfoFront'] = $csmPage->fetchSectionsByIndicator('General-Info', $pageID, $subpageID);
    $_SESSION['csmPage']['genInfoBack'] = $csmPage->fetchSectionsByIndicator('General-Info-Back', $pageID, $subpageID);
    $_SESSION['csmPage']['department'] = $csmPage->fetchSectionsByIndicator('Departments', $pageID, $subpageID);
    $_SESSION['csmPage']['AccordionCourses'] = $csmPage->fetchSectionsByIndicator('Accordion Courses', $pageID, $subpageID);
    $_SESSION['csmPage']['AccordionCoursesUndergrad'] = $csmPage->fetchSectionsByIndicator('Accordion Courses Undergrad', $pageID, $subpageID);
    $_SESSION['csmPage']['AccordionCoursesGrad'] = $csmPage->fetchSectionsByIndicator('Accordion Courses Grad', $pageID, $subpageID);
    ...
    $sections = [
        ...
        'Department' => $_SESSION['csmPage']['department'],
