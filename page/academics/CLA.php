...
/** @region Carousel */
    ...
    ";
    $carouselItems = $claPage->execQuery($carouselItemsSQL);
...
/** @region Card Front */
        ...
        $cardFrontItems = $claPage->execQuery($cardFrontItemsSQL);
...
/** @region Card Back */
    ...
    $cardBackItems = $claPage->execQuery($CardBackItemsSQL);
...
/** @region Accordion Courses */
    ...
    // ✅ Execute the query
    $accordionCourses = $claPage->execQuery($accordionCoursesSQL);
