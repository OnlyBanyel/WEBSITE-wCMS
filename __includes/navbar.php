  ...
  <div id="mobile-menu" class="mobile-menu">
    <div class="mobile-menu-links">
      ...
      <div class="mobile-dropdown-container">
        <a href="javascript:void(0)" class="mobile-link mobile-dropdown-toggle" data-target="about-mobile-dropdown">
          ABOUT US <span class="dropdown-arrow">▼</span>
        </a>
        <div id="about-mobile-dropdown" class="mobile-dropdown">
      ...
      <div class="mobile-dropdown-container">
        <a href="javascript:void(0)" class="mobile-link mobile-dropdown-toggle" data-target="admissions-mobile-dropdown">
          ADMISSIONS <span class="dropdown-arrow">▼</span>
        </a>
        <div id="admissions-mobile-dropdown" class="mobile-dropdown">
          <div class="mobile-dropdown-section">
            <h6 class="inter-bold">ADMISSION GUIDE</h6>
            <p class="inter-light">New Students</p>
            <p class="inter-light">Old Students</p>
      ...
      <div class="mobile-dropdown-container">
        <a href="javascript:void(0)" class="mobile-link mobile-dropdown-toggle" data-target="academics-mobile-dropdown">
          ACADEMICS <span class="dropdown-arrow">▼</span>
        </a>
        <div id="academics-mobile-dropdown" class="mobile-dropdown">
          <div class="mobile-dropdown-section">
            <h6 class="inter-bold">COLLEGE DEPARTMENT</h6>
            <?php 
            $i = 1;
      ...
      <a href="" class="mobile-link">ADMINISTRATION</a>
...
<script>
  ...
  document.querySelectorAll('.mobile-dropdown-toggle').forEach(function(toggle) {
    toggle.addEventListener('click', function() {
      ...
      document.querySelectorAll('.mobile-dropdown.active').forEach(function(activeDropdown) {
        if (activeDropdown.id !== targetId) {
          activeDropdown.classList.remove('active');
          
          // Reset arrow for other toggles
          document.querySelectorAll('.mobile-dropdown-toggle').forEach(function(otherToggle) {
            if (otherToggle.getAttribute('data-target') !== targetId) {
              otherToggle.querySelector('.dropdown-arrow').textContent = '▼';
            }
          });
        }
      });
